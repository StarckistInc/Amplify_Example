...
@ModelConfig(pluralName = "Photos", authRules = {
...
public final class Photo implements Model {
  ...
  public static final QueryField NAME = field("Photo", "name");
  public static final QueryField DESCRIPTION = field("Photo", "description");
  public static final QueryField CATEGORY = field("Photo", "category");
  public static final QueryField PHOTO = field("Photo", "photo");
  private final @ModelField(targetType="ID", isRequired = true) String id;
  private final @ModelField(targetType="String", isRequired = true) String name;
  private final @ModelField(targetType="String") String description;
  private final @ModelField(targetType="category") Category category;
  ...
  private Photo(String id, String name, String description, Category category, S3Object photo) {
    this.id = id;
    this.name = name;
  ...
  @Override
   public boolean equals(Object obj) {
      ...
      return ObjectsCompat.equals(getId(), photo.getId()) &&
              ObjectsCompat.equals(getName(), photo.getName()) &&
              ObjectsCompat.equals(getDescription(), photo.getDescription()) &&
              ObjectsCompat.equals(getCategory(), photo.getCategory()) &&
              ObjectsCompat.equals(getPhoto(), photo.getPhoto()) &&
  ...
  public final class CopyOfBuilder extends Builder {
    private CopyOfBuilder(String id, String name, String description, Category category, S3Object photo) {
      super.id(id);
      super.name(name)
