package com.amplifyframework.samples.gettingstarted.TodoList;
...
import com.amplifyframework.samples.gettingstarted.ViewList.PhotoItemActivity;
...
public class TodoListActivity extends ListActivity implements TodoItemAdapter.OnItemClickListener {
    ...
    public void fabAction2() {
        Intent intent = new Intent(TodoListActivity.this, PhotoItemActivity.class);
